...
CHUNK01A_SHA = 'f5be9110a167b9fc37d9fe0245154ebf732c2aa2a4fed1ef9aa93ba4625ff195'
CHUNK01B_SHA = '5c35c5fc395f3f91701e91cded6474fb4bf6aa417f18b7314cdcfb3490255152'
...
parts = []
parts.append(read_checked('00.txt', EXPECTED['00.txt']))

# Chunk 01 is intentionally staged as two smaller verified parts to avoid transport truncation.
part01a = (PAYLOAD_DIR / '01a.txt').read_text(encoding='ascii').strip()
part01b = (PAYLOAD_DIR / '01b.txt').read_text(encoding='ascii').strip()
print(f'01a.txt: len={len(part01a)} sha256={sha_text(part01a)} expected={CHUNK01A_SHA}')
print(f'01b.txt: len={len(part01b)} sha256={sha_text(part01b)} expected={CHUNK01B_SHA}')
part01 = part01a + part01b
if sha_text(part01) != CHUNK01_SHA:
    raise RuntimeError(f'payload chunk hash mismatch: reconstructed 01.txt: {sha_text(part01)}')
parts.append(part01)
...
h12b = sha_text(raw12b) if raw12b else 'MISSING'
...
if h12 == FULL12:
    parts.append(raw12)
elif h12 == HALF12A and h12b == HALF12B:
    parts.append(raw12 + raw12b)
else:
    raise RuntimeError('payload staging mismatch: 12.txt/12b.txt')
...
print(f'payload zip sha256={actual_payload_sha} expected={PAYLOAD_SHA}')
